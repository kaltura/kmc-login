package com.kaltura.delegates.metadata_metadatabatch
{
	...
	public class Metadata_metadatabatchGetExclusiveJobsDelegate extends WebDelegateBase
	{
		public function Metadata_metadatabatchGetExclusiveJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
