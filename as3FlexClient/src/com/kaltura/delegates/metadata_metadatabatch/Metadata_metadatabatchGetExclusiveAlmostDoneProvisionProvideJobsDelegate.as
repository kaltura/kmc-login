package com.kaltura.delegates.metadata_metadatabatch
{
	...
	public class Metadata_metadatabatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate extends WebDelegateBase
	{
		public function Metadata_metadatabatchGetExclusiveAlmostDoneProvisionProvideJobsDelegate(call:KalturaCall, config:KalturaConfig)
		{
			super(call, config);
		}
