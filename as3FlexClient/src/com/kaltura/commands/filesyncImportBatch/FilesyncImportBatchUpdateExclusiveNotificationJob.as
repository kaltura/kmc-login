package com.kaltura.commands.filesyncImportBatch
{
	...
	public class FilesyncImportBatchUpdateExclusiveNotificationJob extends KalturaCall
	{
		...
		public function FilesyncImportBatchUpdateExclusiveNotificationJob( id : int,lockKey : KalturaExclusiveLockKey,job : KalturaBatchJob,entryStatus : int=undefined )
		{
