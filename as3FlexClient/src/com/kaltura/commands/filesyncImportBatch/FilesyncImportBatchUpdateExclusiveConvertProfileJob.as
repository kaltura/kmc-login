package com.kaltura.commands.filesyncImportBatch
{
	...
	public class FilesyncImportBatchUpdateExclusiveConvertProfileJob extends KalturaCall
	{
		...
		public function FilesyncImportBatchUpdateExclusiveConvertProfileJob( id : int,lockKey : KalturaExclusiveLockKey,job : KalturaBatchJob,entryStatus : int=undefined )
		{
