package com.kaltura.commands.filesyncImportBatch
{
	...
	public class FilesyncImportBatchUpdateExclusiveStorageDeleteJob extends KalturaCall
	{
		...
		public function FilesyncImportBatchUpdateExclusiveStorageDeleteJob( id : int,lockKey : KalturaExclusiveLockKey,job : KalturaBatchJob,entryStatus : int=undefined )
		{
