package com.kaltura.commands.filesyncImportBatch
{
	...
	public class FilesyncImportBatchUpdateExclusiveStorageExportJob extends KalturaCall
	{
		...
		public function FilesyncImportBatchUpdateExclusiveStorageExportJob( id : int,lockKey : KalturaExclusiveLockKey,job : KalturaBatchJob,entryStatus : int=undefined )
		{
